...
namespace NoteProject.API.Migrations
{
    ...
    [Migration("20231214211635_UpdatedUserSlice")]
    partial class UpdatedUserSlice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NoteProject.API.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("NoteProject.API.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("NoteProject.API.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NoteProject.API.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NoteProject.API.Entities.Note", b =>
                {
                    ...
                    b.HasOne("NoteProject.API.Entities.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
